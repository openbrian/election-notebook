<template>
  <div>
    <h1>2022 Senate Election Tracker</h1>
    <p>
    ...
    <p>
      <a href="https://en.wikipedia.org/wiki/2022_United_States_Senate_elections">2022 United States Senate Election on Wikipedia</a>
    </p>
    <h2>Class 3 (close races)</h2>
    <v-sheet>
      <v-simple-table>
    ...
    let st = [
      {
        id: "Georgia",
        special: false,
        incumbent: { name: "Raphael Warnock", party: "D" },
        candidates: [
          { name: "Raphael Warnock", party: "D" },
          { name: "Herschel Walker", party: "R" },
        ],
      },
      {
        id: "Pennsylvania",
        special: false,
        incumbent: { name: "Pat Toomey", party: "R" },
        candidates: [
          { name: "John Fetterman", party: "D" },
          { name: "Mehmet Oz", party: "R" },
        ],
      },
      {
        id: "Nevada",
        special: false,
        incumbent: { name: "Catherine Cortez Masto", party: "D" },
        candidates: [
          { name: "Catherine Cortez Masto", party: "D" },
          { name: "Adam Laxalt", party: "R" },
        ],
      },
      {
        id: "Arizona",
        special: false,
        incumbent: { name: "Mark Kelly", party: "D" },
        candidates: [
          { name: "Mark Kelly", party: "D" },
          { name: "Blake Masters", party: "R" },
        ],
      },
      {
        id: "New Hampshire",
        special: false,
        incumbent: { name: "Maggie Hassan", party: "D" },
        candidates: [
          { name: "Don Bolduc", party: "R" },
      ...
      },
      {
        id: "Wisconsin",
        special: false,
        incumbent: { name: "Ron Johnson", party: "R" },
        candidates: [
          { name: "Ron Johnson", party: "R" },
          { name: "Mandela Barnes", party: "D" },
        ],
      },
      {
        id: "North Carolina",
        special: false,
        incumbent: { name: "Richard Budd", party: "R" },
        candidates: [
          { name: "Cheri Beasley", party: "D" },
          { name: "Richard Budd", party: "R" },
        ],
      },
      {
        id: "Ohio",
        special: false,
        incumbent: { name: "Rob Portman", party: "R" },
        candidates: [
          { name: "J. D. Vance", party: "R" },
          { name: "Tim Ryan", party: "D" },
        ],
      },
      // {
      //   id: "Idaho",
