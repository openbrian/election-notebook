<template>
  <div>
    <h1>2022 House Election Tracker</h1>
<!--    <p>-->
...
<!--    </p>-->
    <p>
      <a href="https://en.wikipedia.org/wiki/2022_United_States_House_elections">2022 United States House Election on Wikipedia</a>
    </p>
    <v-sheet>
      <div v-for="state in states" :key="state.id">
        ...
        <v-simple-table>
          <template v-slot:default>
            ...
            <tbody>
            <tr v-for="district in state.districts" :key="district.location">
              <th>{{ district.location }} {{ district.special ? "special" : ""}}</th>
              <td>{{ district.close }}</td>
              <td><span class="person" :class="district.incumbent.party">{{ district.incumbent.name }} ({{district.incumbent.party}})</span></td>
              <td>
                <ul class="candidates">
                  <li class="person" :class="c.party" v-for="c in district.candidates"><input type="checkbox" /> {{ c.name }} ({{c.party}})</li>
                </ul>
              </td>
            </tr>
            </tbody>
        ...
        districts: [
          {
            ...
            close: false,
            special: false,
            incumbent: { name: "Rob Wittman", party: "R" },
            candidates: [
              { name: "Rob Wittman", party: "R" },
              { name: "Herbert Jones Jr.", party: "D" },
              { name: "David Foster", party: "I" },
            ],
          },
          {
            location: 2,
            close: true,
            special: false,
            incumbent: { name: "Elaine Luria", party: "D" },
            candidates: [
              { name: "Jen Kiggans", party: "R" },
              { name: "Elaine Luria", party: "D" },
            ],
          },
          {
            location: 3,
            close: false,
            special: false,
            incumbent: { name: "Bobby Scott", party: "D" },
            candidates: [
              { name: "Terry Namkung", party: "R" },
              { name: "Bobby Scott", party: "D" },
            ],
          },
          {
            location: 4,
            close: false,
            special: false,
            incumbent: { name: "Donald McEachin", party: "D" },
            candidates: [
              { name: "Leon Benjamin", party: "R" },
              { name: "Donald McEachin", party: "D" },
            ],
          },
          {
            location: 5,
            close: false,
            special: false,
            incumbent: { name: "Bob Good", party: "R" },
            candidates: [
              { name: "Bob Good", party: "R" },
              { name: "Joshua Throneburg", party: "D" },
            ],
          },
          {
            location: 6,
            close: false,
            special: false,
            incumbent: { name: "Ben Cline", party: "R" },
            candidates: [
              { name: "Ben Cline", party: "R" },
              { name: "Jennifer Lewis", party: "D" },
            ],
          },
          {
            location: 7,
            close: true,
            special: false,
            incumbent: { name: "Abigail Spanberger", party: "D" },
            candidates: [
              { name: "Yesli Vega", party: "R" },
              { name: "Abigail Spanberger", party: "D" },
            ],
          },
          {
            location: 8,
            close: false,
            special: false,
            incumbent: { name: "Don Beyer", party: "D" },
            candidates: [
              { name: "Jaruba Kuosnab", party: "R" },
              { name: "Don Beyer", party: "D" },
              { name: "Teddy Fikre", party: "I" },
            ],
          },
          {
            location: 9,
            close: false,
            special: false,
            incumbent: { name: "Morgan Griffith", party: "R" },
            candidates: [
              { name: "Morgan Griffith", party: "R" },
              { name: "Taysha DeVaughan", party: "D" },
            ],
          },
          {
            location: 10,
            close: false,
            special: false,
            incumbent: { name: "Jennifer Wexton", party: "D" },
            candidates: [
              { name: "Hung Cao", party: "R" },
              { name: "Jennifer Wexton", party: "D" },
            ],
          },
          {
            location: 11,
            close: false,
            special: false,
            incumbent: { name: "Gerry Connolly", party: "D" },
            candidates: [
              { name: "James Myles", party: "R" },
              { name: "Gerry Connolly", party: "D" },
            ],
          },
        ],
      },
